...
public class MainApp extends Application {
     ...
     */
    private ObservableList<Student> personData = FXCollections.observableArrayList();
     ...
     * @return
     */
    public ObservableList<Student> getPersonData() {
        return personData;
    }
    ...
    public void start(Stage primaryStage) {
        ...
        this.primaryStage.setTitle("Input student");
